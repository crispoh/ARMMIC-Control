...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        def test_up():
            valor = '$J=G21G91Y10F60' + '\n'
            ser.write(valor.encode())
            print("UP ")
        # Función BAJAR un paso
        def test_down():
            valor = '$J=G21G91Y-10F60' + '\n'
            ser.write(valor.encode())
            print("DOWN")
        # Función un paso IZQUIERDA
        def test_left():
            valor = '$J=G21G91X-10F60' + '\n'
            ser.write(valor.encode())
            print("LEFT")
        # Función un paso DERECHA
        def test_right():
            valor = '$J=G21G91X10F60' + '\n'
            ser.write(valor.encode())
            print("RIGHT")
        # Función Mapeo
        ...
        ### Buttons 
        self.third_frame_button_1 = customtkinter.CTkButton(self.frame_test_mid, text="", image=self.home_image, height=45, width=45, command=go_home)
        self.third_frame_button_1.grid(row=1, column=1, padx=5, pady=5)
        self.third_frame_button_2 = customtkinter.CTkButton(self.frame_test_mid, text="", image=self.row_image_up, height=60, width=45, command=test_up)
        self.third_frame_button_2.grid(row=0, column=1, pady=(20,5))
        self.third_frame_button_3 = customtkinter.CTkButton(self.frame_test_mid, text="", image=self.row_image_down, height=60, width=45, command=test_down)
        self.third_frame_button_3.grid(row=2, column=1, pady=(5,20))
        self.third_frame_button_4 = customtkinter.CTkButton(self.frame_test_mid, text="", image=self.row_image_left, height=45, width=60, command=test_left)
        self.third_frame_button_4.grid(row=1, column=0, padx=(20,5))
        self.third_frame_button_5 = customtkinter.CTkButton(self.frame_test_mid, text="", image=self.row_image_right, height=45, width=60, command=test_right)
        self.third_frame_button_5.grid(row=1, column=2, padx=(5,20))
